...
{
    Console.WriteLine("Нет");           // Замечание преподавателя - некорректный результат для чисел вне допустимого
}                                       // диапазона (всегда Нет). Нужно было сделать отдельное сообщение